...
function DataTable({ columns, data }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("table", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("thead", { children: table.getHeaderGroups().map((hg) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tr", { children: hg.headers.map((h) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { children: h.isPlaceholder ? null : flexRender(h.column.columnDef.header, h.getContext()) }, h.id)) }, hg.id)) }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tbody", { children: table.getRowModel().rows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tr", { children: r.getVisibleCells().map((c) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { children: flexRender(c.column.columnDef.cell, c.getContext()) }, c.id)) }, r.id)) })
  ] });
}
...
function Countdown({ to, onDone, className }) {
  const [left, setLeft] = React2.useState(() => (typeof to === "number" ? to : new Date(to).getTime()) - Date.now());
  React2.useEffect(() => {
